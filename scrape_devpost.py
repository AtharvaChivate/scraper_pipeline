...
def fetch_hackathons(base_url, total_pages, session):
    all_hackathons = []
    headers = {
...
def save_to_s3(hackathons, bucket_name, file_name, session):
    if hackathons:
...
def main():
    ...
    all_hackathons = fetch_hackathons(base_url, total_pages, session)
    save_to_s3(all_hackathons, bucket_name, file_name, session)
